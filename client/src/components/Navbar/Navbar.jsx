        ...
        <div className='fixed flex flex-1 w-screen px-6 pr-3 md:px-32  bg-bg-light dark:bg-bg-dark z-50'>
            <div className='w-full flex justify-end px-4 md:justify-between '>
                ...
                <div className='absolute w-1/2  left-0  md:hidden '>
                    <button
                        className='font-bold text-3xl p-8 py-6 '
                        onClick={() => setisOpen(!isOpen)}
                    >
                        <HiMenuAlt1 />
                    </button>
                    {isOpen && (
                        <nav className='relative flex flex-col gap-y-8 items-center justify-center h-screen w-full z-50 bg-bg-light dark:bg-bg-dark '>
                            <Link
                                to='/'
